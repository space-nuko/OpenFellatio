...
class CharacterControl {
	...
	public var irisRGB:Color = new Color(0, 0, 0, 0);
	public var lipstickRGB:Color = new Color(0, 0, 0, 0);
	public var eyebrowFillRGB:Color = new Color(0, 0, 0, 0);
	public var eyebrowLineRGB:Color = new Color(0, 0, 0, 0);
	public var eyeShadowRGB:Color = new Color(0, 0, 0, 0);
	public var scleraRGB:Color = new Color(0, 0, 0, 0);
	public var blushRGB:Color = new Color(0, 0, 0, 0);
	public var frecklesRGB:Color = new Color(0, 0, 0, 0);
	public var mascaraRGB:Color = new Color(0, 0, 0, 0);
	public var nailPolishRGB:Color = new Color(0, 0, 0, 0);
	...
	public var scalpFills:Array<Array<Color>> = [
			new Color(227, 189, 168),
			new Color(222, 202, 191),
			new Color(241, 182, 138),
			new Color(118, 79, 52),
		];
	public var breastOffset:Array<UInt> = [2, 152, 302, 452, 602];
	public var currentBreastOffset:Float = Math.NaN;
	public var browOffsets:Array<ASAny> = [0, 199, 399, 599];
	public var lipOffsets:Array<ASAny> = [2, 82, 162, 242];
	...
	public var collarNameList:Array<ASAny> = ["None", "Leather", "Tie", "Gem Choker"];
	public var gagNameList:Array<ASAny> = ["None", "Ring", "Dental", "Tube"];
	public var cuffsNameList:Array<ASAny> = ["None", "Leather", "Shirt"];
	public var ankleCuffsNameList:Array<ASAny> = ["None", "Leather", "Panties", "Left Ribbon", "Right Ribbon", "Left Anklet", "Right Anklet"];
	public var pantiesNameList:Array<ASAny> = ["None", "Briefs", "Bikini", "Thong", "Side Tie", "High Leg"];
	public var armwearNameList:Array<ASAny> = ["None", "Wrist Glove", "Elbow Glove"];
	public var legwearNameList:Array<ASAny> = [
	...
	public var bottomsNameList:Array<ASAny> = ["None", "Skirt", "Bike Shorts", "Boyshorts", "Jeans", "Jean Shorts", "Miniskirt"];
	public var footwearNameList:Array<ASAny> = ["None", "Highheel", "School"];
	public var eyewearNameList:Array<ASAny>= ["None", "Mari", "Pince Nez", "Blindfold", "Leather"];
	public var topNameList:Array<ASAny>= ["None", "T-Shirt", "Tank", "Cropped", "Cropped Tank", "Shirt"];
	public var braNameList:Array<ASAny>= ["None", "Bra", "Bikini"];
	public var tonguePiercingNameList:Array<ASAny>= ["None", "Barbell", "Double", "Ring"];
	public var nipplePiercingNameList:Array<ASAny>= ["None", "Barbell", "Ring", "Large Ring", "Weight"];
	public var bellyPiercingNameList:Array<ASAny>= ["None", "Stud", "Ring", "Gem"];
	public var earringNameList:Array<ASAny>= ["None", "Stud", "Ring", "Ball", "Teardrop", "Feather"];
	public var headwearNameList:Array<ASAny> =[
			"None",
			"Cat Ears",
			"Bat Wings",
			"Band",
	...
	public function registerComponents() {
		if (!this.componentsRegistered) {
			...
			this.cuffsControl.registerComponents([G.her.torso.cuffs,G.her.rightForeArmContainer.upperArmCostume.foreArmCostume.cuff,G.her.leftArmContainer.upperArmCostume.foreArmCostume.cuff]);
			...
			this.pantiesControl.registerComponents([G.her.torso.rightThighCostume.panties,G.her.leftLegContainer.leg.leftThighCostume.panties,G.her.torso.backUnderCostume.panties,G.her.torso.chestUnderCostume.panties,G.her.torsoBackCostume.backsideCostume.panties]);
			this.armwearControl.registerComponents([G.her.torso.leftGlove,G.her.torso.rightGlove,G.her.rightForeArmContainer.upperArmCostume.foreArmCostume.glove,G.her.leftArmContainer.upperArmCostume.foreArmCostume.glove,G.her.rightForeArmContainer.upperArmCostume.foreArmCostume.handCostume.glove,G.her.leftArmContainer.upperArmCostume.foreArmCostume.handCostume.glove,G.her.rightArmContainer.upperArmCostume.glove,G.her.leftArmContainer.upperArmCostume.glove,G.her.leftHandOver.hand.glove]);
			this.legwearControl.registerComponents([G.her.torso.rightThighStocking,G.her.torso.rightCalfContainer.calfStocking,G.her.leftLegContainer.leg.stocking,G.her.leftLegContainer.leg.calfStocking,G.her.torsoBackCostume.backsideCostume.stocking]);
			this.legwearBControl.registerComponents([G.her.torso.rightThighStockingB,G.her.torso.rightCalfContainer.calfStockingB,G.her.leftLegContainer.leg.stockingB,G.her.leftLegContainer.leg.calfStockingB,G.her.torsoBackCostume.backsideCostume.stockingB]);
			this.bottomsControl.registerComponents([G.her.torso.rightThighBottoms,G.her.torso.rightThighBottomsOver,G.her.torso.rightCalfContainer.bottoms,G.her.torso.chestCostume.bottoms,G.her.torso.backCostume.bottoms,G.her.leftLegContainer.leg.leftThighBottoms,G.her.leftLegContainer.leg.leftCalfBottoms,G.her.torsoBackCostume.backsideCostume.bottoms],ModTypes.BOTTOMS);
			...
			this.topControl.registerComponents([G.her.torso.topContainer.breastTop,G.her.torso.topContainer.chestTop,G.her.torso.topContainer.backTop,G.her.torso.topContainer.topStrap,G.her.torsoBackCostume.breastCostume.top,G.her.torsoUnderCostume.top,G.her.rightArmContainer.upperArmCostume.top,G.her.leftArmContainer.upperArmCostume.top],ModTypes.TOP);
			this.braControl.registerComponents([G.her.torso.breastCostume.bra,G.her.torso.braStrap,G.her.torso.shoulderStrap,G.her.torso.upperChestCostume.bra,G.her.torsoBackCostume.breastCostume.bra]);
			this.headwearControl.registerComponents([G.hairCostumeOver.headwear,G.hairCostumeBack.headwear],ModTypes.HEADWEAR);
			this.tonguePiercingControl.registerComponents([G.her.tongueContainer.tongue.piercing,G.her.tongueContainer.tongue.piercingBack,G.her.topLipTongue.piercing,G.her.topLipTongue.piercingBack],ModTypes.TONGUE_PIERCING);
	...
	public function initChar(param1:Bool = true) {
		...
		this.setNailPolish(new Color(0, 0, 0, 0));
	...
	public function setBreasts(param1:Int = -1) {
		...
		this.breastSize = param1;
		        ...
		        this.setBreastFrame(G.her.torso.midLayer.rightBreast);
		         if(G.her.torsoBack.leftBreast.nipple.getChildByName("leftNipple"))
		         {
		         ...
		         if(G.her.torso.midLayer.rightBreast.nipple.getChildByName("rightNipple"))
		         {
	...
	public function setIrisFill(param1:Color, param2:String = "rgbFill") {
	...
	public function setLipstick(param1:Color, param2:String = "rgbFill") {
		var _loc3_ = new ColorTransform(1, 1, 1, param1.a, param1.r, param1.g, param1.b);
	...
	public function setNailPolish(param1:Color, param2:String = "rgbFill") {
		var _loc3_ = new ColorTransform(1, 1, 1, param1.a, param1.r, param1.g, param1.b);
	...
	public function findCollar(param1:String) {
		...
		var _loc2_ = Math.ffloor(ASCompat.toNumber(param1));
	...
	public function setLegwearFillA(param1:ASObject, param2:String = "rgbFill") {
		this.setLegwearFill(this.legwearControl, "", param1, param2);
	}

	public function setLegwearFillB(param1:ASObject, param2:String = "rgbFill") {
		this.setLegwearFill(this.legwearBControl, "B", param1, param2);
	}

	public function setLegwearA(param1:UInt) {
		this.setLegwear(this.legwearControl, param1, "");
	}

	public function setLegwearB(param1:UInt) {
		this.setLegwear(this.legwearBControl, param1, "B");
	}

	public function setLegwear(param1:CharacterElementHelper, param2:UInt, param3:String) {
		        tryToSetFrameLabel(G.her.torso["rightThighStocking" + param3].stocking,this.legwearNameList[param1.selection]);
		        tryToSetFrameLabel(G.her.torso["rightThighStocking" + param3].stocking.hipLayer.backStocking,this.legwearNameList[param1.selection]);
		        tryToSetFrameLabel(G.her.torso["rightThighStocking" + param3].stocking.hipLayer.chestStocking,this.legwearNameList[param1.selection]);
		        tryToSetFrameLabel(G.her.torso["rightThighStocking" + param3].stocking.hipOverLayer.backStocking,this.legwearNameList[param1.selection]);
		        tryToSetFrameLabel(G.her.torso["rightThighStocking" + param3].stocking.hipOverLayer.chestStocking,this.legwearNameList[param1.selection]);
		        tryToSetFrameLabel(G.her.torso["rightThighStocking" + param3].stocking2,this.legwearNameList[param1.selection]);
		        tryToSetFrameLabel(G.her.torso["rightThighStocking" + param3].stocking2.hipLayer.backStocking,this.legwearNameList[param1.selection]);
		        tryToSetFrameLabel(G.her.torso["rightThighStocking" + param3].stocking2.hipLayer.chestStocking,this.legwearNameList[param1.selection]);
		        tryToSetFrameLabel(G.her.torso.rightCalfContainer["calfStocking" + param3],this.legwearNameList[param1.selection]);
		        tryToSetFrameLabel(G.her.leftLegContainer.leg["stocking" + param3],this.legwearNameList[param1.selection]);
		        tryToSetFrameLabel(G.her.leftLegContainer.leg["calfStocking" + param3],this.legwearNameList[param1.selection]);
		tryToSetFrameLabel(G.her.torsoBackCostume.backsideCostume["stocking" + param3],this.legwearNameList[param1.selection]);
	}

	public function setLegwearFill(param1:CharacterElementHelper, param2:String, param3:ASObject, param4:String = "rgbFill") {
		...
		if (param4 == "rgbFill") {
			if (param1.selectedName == "Pantyhose" || param1.selectedName == "Garter Belt") {
				...
				G.her.torso["rightThighStocking" + param2].stocking.filters = [_loc7_];
				G.her.torso["rightThighStocking" + param2].stocking2.filters = [_loc7_];
			} else {
				G.her.torso["rightThighStocking" + param2].stocking.filters = [];
				G.her.torso["rightThighStocking" + param2].stocking2.filters = [];
			}
		}
		tryToSetFill(G.her.torso["rightThighStocking" + param2].stocking,param4,_loc6_);
		tryToSetFill(G.her.torso["rightThighStocking" + param2].stocking.hipLayer.backStocking,param4,_loc6_);
		tryToSetFill(G.her.torso["rightThighStocking" + param2].stocking.hipLayer.chestStocking,param4,_loc6_);
		tryToSetFill(G.her.torso["rightThighStocking" + param2].stocking.hipOverLayer.backStocking,param4,_loc6_);
		tryToSetFill(G.her.torso["rightThighStocking" + param2].stocking.hipOverLayer.chestStocking,param4,_loc6_);
		tryToSetFill(G.her.torso["rightThighStocking" + param2].stocking2,param4,_loc6_);
		tryToSetFill(G.her.torso["rightThighStocking" + param2].stocking2.hipLayer.backStocking,param4,_loc6_);
		tryToSetFill(G.her.torso["rightThighStocking" + param2].stocking2.hipLayer.chestStocking,param4,_loc6_);
		tryToSetFill(G.her.torso.rightCalfContainer["calfStocking" + param2],param4,_loc5_);
		tryToSetFill(G.her.leftLegContainer.leg["stocking" + param2],param4,_loc5_);
		tryToSetFill(G.her.leftLegContainer.leg["calfStocking" + param2],param4,_loc5_);
		tryToSetFill(G.her.torsoBackCostume.backsideCostume["stocking" + param2],param4,_loc5_);
	}
		...
		if (!this.customHairLoaded) {
			...
			if ((G.hairCostumeOver.headwear : ASAny)["landingPoint"]) {
				...
				do {
					...
					_loc3_ = _loc4_;
					_loc4_ = (_loc4_ = (_loc4_ = (_loc4_ = false) || G.hairOverLayer.hitTestPoint(_loc2_.x,_loc2_.y,true)) || G.hairTop.hitTestPoint(_loc2_.x,_loc2_.y,true)) || G.her.hairMidContainer.hitTestPoint(_loc2_.x,_loc2_.y,true);
