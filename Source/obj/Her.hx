...
class Her extends MovieClip {
    ...
    public var topLipA:Point = new Point(141, -60);
    public var topLipB:Point = new Point(121, -52);
    public var midMouth:Point = new Point(122, -28);
    public var bottomLipA:Point = new Point(138, 74);
    public var bottomLipB:Point = new Point(146, 33);
    public var offBottomLip:Point = new Point(144, 68);
    public var eyelidEnd:Point = new Point(84, -115);
    public var eyelidStart:Point = new Point(41, -136);
    public var nostril:Point = new Point(135, 68);
    public var armConnection:Point = new Point(-7, -221);
    public var hairLimits:Array<Float> = [-0.5, -1, 0.5];
    public var eyeAim:Point = new Point(16, -138);
    public var hisFace:Point = new Point(800, -270);
    public var eyesDown:Point = new Point(800, 160);
    public var eyesUnfocused:Point = new Point(900, 0);
    ...
    public function new() {
        ...
        this.shoulderStrapController = new BraStrap(this.torso.shoulderStrap, this.torso.breastCostume.bra, "shoulderStrapPoint",
            G.characterControl.braControl);
        this.topStrapController = new BraStrap(this.torso.topContainer.topStrap, this.torso.topContainer.breastTop, "strapPoint",
            G.characterControl.topControl);
