...
class ASCompat {
	...
	// #if !flash
	// @:noCompletion public static inline function _asVector<T>(value:Any):Null<flash.Vector<T>> return if (Std.isOfType(value, IVector)) value else null;
	// @:noCompletion public static inline function _isVector(value:Any):Bool return Std.isOfType(value, IVector);
	// #end
